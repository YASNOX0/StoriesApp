...
public class HistoireRVAdapter extends RecyclerView.Adapter<HistoireRVAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_hitoires_recycler_view_template, parent, false);
    ...
    private void deleteHistoire(Histoire histoire) {
        // Add logic to delete the histoire
        Toast.makeText(this.context, "Delete action triggered", Toast.LENGTH_SHORT).show();
    }
    ...
    private void showBottomSheetDialog(Histoire histoire) {
        ...
        this.setupBottomSheetView(view, histoire);

        bottomSheetDialog.setContentView(view);
        bottomSheetDialog.show();
    }

    private void setupBottomSheetView(View view, Histoire histoire) {
        ...
        btn_supprimer.setOnClickListener(v -> this.deleteHistoire(histoire));
        btn_modifier.setOnClickListener(v -> this.navigateToHistoireManipulation(histoire, "Modifier"));
    }
